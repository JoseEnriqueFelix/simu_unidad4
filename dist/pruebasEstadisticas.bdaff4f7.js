...
},{"../dist/chart.js":"../node_modules/chart.js/dist/chart.js"}],"pruebasEstadisticas.js":[function(require,module,exports) {
"use strict";
...
function generaIntervalos(arr, w, k) {
  var inter = [];
  inter.push(Math.min.apply(Math, _toConsumableArray(arr)) + w);
  for (var i = 1; i < k; i++) {
...
function chiCuadrada(intervalos, randoms, k, e) {
  var a = 0;
  var suma = 0;
  var o = Array(k).fill(0);
  for (var i = 0; i < randoms.length; i++) {
    if (randoms[i] >= Math.min.apply(Math, _toConsumableArray(randoms)) && randoms[i] < intervalos[0]) {
      o[0]++;
    }
  }
  suma += Math.pow(o[0] - e, 2) / e;
  for (var _i = 1; _i < intervalos.length; _i++) {
    for (var j = 0; j < randoms.length; j++) {
      if (randoms[j] >= intervalos[_i - 1] && randoms[j] < intervalos[_i]) {
        o[_i]++;
      }
    }
    suma += Math.pow(o[_i] - e, 2) / e;
    a = _i;
  }
  o[a + 1] = suma;
  return o;
...
_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var precision, n, k, e, valoresAleatorios, i, r, w, intervalos, _i2, data, _i3, obj;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        precision = 2;
        n = prompt("Ingrese el valor de n");
        k = parseInt(Math.sqrt(n));
        e = n / k;
        valoresAleatorios = generaTablaAleatoria(n);
        for (i = 0; i < valoresAleatorios.length; i++) {
          console.log(i + 1 + "\t\t" + valoresAleatorios[i]);
        }
        r = Math.max.apply(Math, _toConsumableArray(valoresAleatorios)) - Math.min.apply(Math, _toConsumableArray(valoresAleatorios));
        w = r / k;
        intervalos = [];
        ...
        for (_i2 = 0; _i2 < valoresO.length - 1; _i2++) {
          console.log(_i2 + 1 + "\t\t" + valoresO[_i2] + "\t\t\t" + e.toFixed(precision) + "\t\t" + (valoresO[_i2] - e).toFixed(precision) + "\t\t\t" + (Math.pow(valoresO[_i2] - e, 2) / e).toFixed(precision));
        }
        console.log("La suma es: " + valoresO[valoresO.length - 1]);
        data = [];
        for (_i3 = 0; _i3 < valoresO.length - 1; _i3++) {
          obj = {
            year: _i3 + 1,
            count: valoresO[_i3]
          };
...
},{"chart.js/auto":"../node_modules/chart.js/auto/auto.js"}],"../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pruebasEstadisticas.js"], null)
//# sourceMappingURL=/pruebasEstadisticas.bdaff4f7.js.map